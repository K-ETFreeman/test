...
var pictures = document.querySelectorAll('.gallery__grid img');
var items = [];	
...
var options = {
	...
	shareButtons : [{id:'download', label:'Скачать изображение', url:'{{raw_image_url}}', download:true}]
};
var gallery;

pictures.forEach(img=>{
	items.push({
		src: img.getAttribute('src').replace('thumb','images'),
		w: img.naturalWidth * (img.getAttribute('data-scale')||2),
		h: img.naturalHeight * (img.getAttribute('data-scale')||2),
